...
╚█████╔╝██████╔╝    ██████╔╝╚██████╔╝╚██████╗██║  ██╗███████╗██║  ██║     ╚████╔╝      ██║
 ╚════╝ ╚═════╝     ╚═════╝  ╚═════╝  ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝      ╚═══╝       ╚═╝
                         ...
                         注意：本脚本已经没有网页版控制面板了！！！
                  如果你会自行安装网页版控制面板，请访问 http://<ip>:5678				 
"
DOCKER_IMG_NAME="qianyi09/jd"
JD_PATH=""
SHELL_FOLDER=$(pwd)
CONTAINER_NAME=""
CONFIG_PATH=""
...
OWN_PATH=$JD_PATH/jd/own
SCRIPT_PATH=$JD_PATH/jd/scripts
DIY_PATH=$JD_PATH/jd/diy
